...
export default function Home() {
  ...
  return (
    <main className="relative">
      <PageBackground image="/background.jpg">
        <div className="grid grid-rows-[auto_1fr_auto] items-center justify-items-center p-8 pb-20 gap-8 sm:p-12 font-[family-name:var(--font-geist-sans)]">
          <header className="w-full flex justify-end items-center">
            ...
            {isAuthenticated ? (
              ...
              <div className="flex gap-4">
                ...
                <Link 
                  href="/register" 
                  className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-white text-gray-900 gap-2 hover:bg-gray-100 font-medium text-sm h-10 px-4"
                >
                  Sign Up
                </Link>
              </div>
          ...
          <main className="flex flex-col gap-[32px] items-center text-center max-w-3xl">
            ...
            <div className="flex gap-6 items-center flex-col sm:flex-row">
              {isAuthenticated ? (
                <Link
                  href="/preferences"
                  className="rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-white text-gray-900 gap-2 hover:bg-gray-100 font-medium text-base h-12 px-6 sm:w-auto"
                >
